...
import com.tencent.qcloud.timchat.utils.EncryptHelper;
    ...
    public TextMessage(Editable s){
        ...
        for (ImageSpan span : listSpans){
            ...
            if (currentIndex < startIndex){
                ...
                textElem.setText(EncryptHelper.encryption(text));
        ...
        for (int i = 0; i<message.getElementCount(); ++i){
            switch (message.getElement(i).getType()){
                ...
                case Text:
                    ...
                    result.append(EncryptHelper.decryption(textElem.getText()));
                    break;
            }
        ...
        for (int i = 0; i<elems.size(); ++i){
            switch (elems.get(i).getType()){
                ...
                case Text:
                    ...
                    stringBuilder.append(EncryptHelper.decryption(textElem.getText()));
                    break;
            }
